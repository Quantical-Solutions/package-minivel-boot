<div id="wormholeBottomBarBtn" class="display_wormholeBottomBarBtn wormholesComponents">
...
<div id="wormholeBottomBarFolderOpen" class="wormholesComponents">
    @include('includes.window')
</div>
@if($ux != false)
    @include('includes.ux')
@endif
<div id="wormholeBottomBar" class="wormholesComponents">
    <style>
    ...
    <script type="text/javascript" src="{{ config('app.url') }}/vendor/quantic/igniter/src/Workers/handlerAssets/assets/highlight.pack.js"></script>
